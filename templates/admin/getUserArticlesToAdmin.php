...
<head>
    ...
    <title>User Admin Articles</title>
    ...
    <table class="w-full table-fixed mt-10">
        ...
        <tr>
            ...
            <td class="py-4 px-6 border-b border-gray-200">
                <a href="?act=articleAdminEdit&id=<?= $row['id']?>" class="bg-green-500 text-white py-1 px-2 rounded-full text-xs">Edit</a>
            </td>
            <td class="py-4 px-6 border-b border-gray-200">
                <a href="?act=articleUserDestroyAdmin&id=<?= $row['id']?>" class="bg-red-500 text-white py-1 px-2 rounded-full text-xs">Delete</a>
            </td>
        </tr>
        <?php endwhile ?>
